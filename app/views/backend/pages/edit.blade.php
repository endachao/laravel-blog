...
{{ Form::model($page, ['route' => ['backend.pages.update', $page->id], 'method' => 'put','class'=>'am-form']) }}
            ...
            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::text('title', $page->title, ['class' => 'am-input-sm']) }}
                    </div>
                ...
                <form class="am-form">
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            {{ Form::text('seo_key',$page->seo_key,['class'=>'am-input-sm']) }}
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            {{ Form::textarea('seo_desc',$page->seo_desc) }}
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    (function($) {
        $('#editor').load('{{ URL::route("backend.pages.show",["id"=>$page->id])}}',
            function(data) {
