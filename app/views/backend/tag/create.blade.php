...
{{ Form::open(['route' => 'backend.tag.store', 'method' => 'post','class'=>'am-form']) }}
...
<div class="admin-content">
    ...
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">标签</strong> / <small>添加标签</small></div>
    </div>
