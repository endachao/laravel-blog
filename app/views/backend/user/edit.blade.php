...
{{ Form::model($user, ['route' => ['backend.user.update', $user->id], 'method' => 'put','class'=>'am-form']) }}
            ...
            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::email('email', $user->email, ['class' => 'am-input-sm']) }}
                    </div>
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::text('first_name',$user->first_name,['class'=>'am-input-sm']) }}
                    </div>
                    <div class="am-hide-sm-only am-u-md-6">
                        <small>
                            *必填
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::text('last_name',$user->last_name,['class'=>'am-input-sm']) }}
                    </div>
                    <div class="am-hide-sm-only am-u-md-6">
                        <small>
                            *必填
