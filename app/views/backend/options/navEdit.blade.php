...
{{ Form::model($nav, ['route' => ['backend.options.putNavEdit', $nav->id], 'method' => 'put','class'=>'am-form']) }}
            ...
            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::text('name',$nav->name, ['class' => 'am-input-sm']) }}
                    </div>
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::text('url',$nav->url, ['class' => 'am-input-sm']) }}
                    </div>
                    <div class="am-hide-sm-only am-u-md-6">
                        <small>
                            *必填
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        {{ Form::text('order_key',$nav->order_key, ['class' => 'am-input-sm']) }}
                    </div>
                    <div class="am-hide-sm-only am-u-md-6">
                        <small>
                            *必填
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-10">
                        ...
                        {{ Form::select('type',['top'=>'导航','bottom'=>'底部'] , $nav->type , ['data-am-selected' => '{btnSize: "sm"}']) }}
